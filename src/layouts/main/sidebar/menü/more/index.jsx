...
export default function More() {
	return (
		<Popover className="relative  ">
			...
			<Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)]  shadow-box rounded-xl shadow-white overflow-hidden ">
				...
				<Disclosure>
					...
					<Disclosure.Button className="h-[52px] flex items-center justify-between w-full px-4 transition-colors  hover:bg-[color:var(--background-secondary)] font-bold">
					...
					<Disclosure.Panel className="">
						...
						<Link to="/"
							className="flex items-center w-full px-3 h-11 gap-3 text-[15px] font-medium transition-colors hover:bg-[color:var(--background-secondary)]">
							<svg viewBox="0 0 24 24" width={18.75} height={18.75}>
								<path
									fill="currentColor"
					...
					<Disclosure.Panel className="">
						...
						<Link to="/"
							className="flex items-center w-full px-3 h-11 gap-3 text-[15px] font-medium transition-colors  hover:bg-[#eff3f41a] ">
							<svg viewBox="0 0 24 24" width={18.75} height={18.75}>
								<path
									fill="currentColor"
						...
						<button
							...
							className="flex items-center w-full px-3 h-11 gap-3 w-full text-[15px] font-medium transition-colors  hover:bg-[color:var(--background-secondary)]  ">
							<svg viewBox="0 0 24 24" width={18.75} height={18.75}>
								<path
									fill="currentColor"
